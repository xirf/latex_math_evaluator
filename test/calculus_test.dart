...
void main() {
  ...
  group('Challenge 5: Calculus (Definite Integral)', () {
    test('Gaussian Integral', () {
      ...
      // Note: Using 'inf' for infinity. The tokenizer needs to support it or we pass it as variable.
      // 'infinity' is often not a keyword. Let's pass it as a variable if needed or use \infty command if parser supports it.
      // Parser usually supports \infty. Let's check Tokenizer support.
      // Assuming \infty maps to DOUBLE_INFINITY or similar.
      // If not, I'll pass 'inf' as a variable.

      // Let's assume \infty parses to infinity.
      final expression = r'''
