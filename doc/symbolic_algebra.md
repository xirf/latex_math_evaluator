...
The `latex_math_evaluator` package includes a powerful symbolic algebra engine capable of expression simplification, expansion, and domain-aware transformations.
