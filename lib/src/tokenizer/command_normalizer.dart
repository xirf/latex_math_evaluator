...
class CommandNormalizer {
  ...
  static Token? normalize(String command, int position) {
    switch (command) {
      ...
      // Division operator
      case 'div':
        return Token(type: TokenType.divide, value: '\\div', position: position);
      
      // Normalize inverse trig aliases to canonical form
      case 'arcsin':
      case 'asin':
        return Token(type: TokenType.function, value: 'asin', position: position);
      
      case 'arccos':
      case 'acos':
        return Token(type: TokenType.function, value: 'acos', position: position);
      
      case 'arctan':
      case 'atan':
        return Token(type: TokenType.function, value: 'atan', position: position);
      
      case 'arccot':
        return Token(type: TokenType.function, value: 'acot', position: position);
      
      case 'arcsec':
        return Token(type: TokenType.function, value: 'asec', position: position);
      
      case 'arccsc':
        return Token(type: TokenType.function, value: 'acsc', position: position);
